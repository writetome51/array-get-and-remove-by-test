...
var getAndRemoveFilteredResults_1 = require("./lib/getAndRemoveFilteredResults");
...
if (arraysMatch_1.arraysMatch(filtered, [1, 10, 1, 1]))
    console.log('test 1 passed');
else
    console.log('test 1 failed');
// Test 2: make sure those items were removed from array:
if (arraysMatch_1.arraysMatch(arr, [2, 3, 4, 5, 6, 7, 8, 9, 2, 3, 2, 3]))
...
if (arraysMatch_1.arraysMatch(filtered, ['hello', 'h', 'h']))
    console.log('test 3 passed');
else
    console.log('test 3 failed');
// Test 4: make sure those items were removed from array:
if (arraysMatch_1.arraysMatch(arr, ['??', 2, 1, 5, 'mertyujkl;', 20]))
...
if (arraysMatch_1.arraysMatch(filtered, [true, true]))
    console.log('test 5 passed');
else
    console.log('test 5 failed');
// Test 6: make sure those items were removed from array:
if (arraysMatch_1.arraysMatch(arr, [[1, 2, 3], 10, false, 2, 'h', 1, 5]))
...
if (arraysMatch_1.arraysMatch(filtered, [[10, 2, 3], [10, 20]]))
    console.log('test 7 passed');
else
    console.log('test 7 failed');
// Test 8: make sure those items were removed from array:
if (arraysMatch_1.arraysMatch(arr, [[2, 3, 4], 1, 5, 6, false]))
